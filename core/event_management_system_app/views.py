...
def category_list(request):
        ...
        #return render(request, 'event_management_system_app/category_list.html',context)
'''
def category_list(request):
        categories = Category.objects.all()
...
def login_page(request):
    ...
    return render(request,'event_management_system_app/login.html')
...
def register_page(request):
    ...
    return render(request,'event_management_system_app/register.html')